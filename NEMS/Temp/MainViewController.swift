...
class MainViewController: UIViewController, MessageDelegate {
    ...
    override func viewDidLoad() {
        ...
        func openPatientPortal() {
            guard let url = URL(string: "https://fhir.nextgen.com/auth/oauth/v2/authorize?response_type=token&prompt=none&client_id=l7f2ac2380f849472f8092393ef83cb14f&redirect_uri=nems-app://oauthCallback") else {
                return
            }
